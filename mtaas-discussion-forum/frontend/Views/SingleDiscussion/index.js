...
class SingleDiscussion extends Component {
  ...
  componentDidMount() {
    ...
    console.log("params in comp DID MOUNT..... ", this.props.params)
  ...
  handleReplySubmit() {
    ...
    let temp = this.props.opinionContent;
    ...
    console.log("Inside handleReplySubmit")
  ...
  render() {
    ...
    return (
      <div className={appLayout.constraintWidth}>
        <Helmet><title>{`${title} | MTaaS`}</title></Helmet>
