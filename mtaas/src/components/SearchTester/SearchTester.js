...
render(){
  if(searchFlag){
    redirectNav=<Redirect to='/filtertester'/>
  }
  return (
    <Form >
      {redirectNav}
      ...
      <Input type="text" name="seachText" id="searchText" placeholder="Search Tester based on Technology" />
        ...
        <Col md={6}>
        <Button onClick={this.searchTester}>Submit</Button>
        </Col>
  </Row>
  ...
  return (
    ...
    <div>
      <Modal isOpen={modal} toggle={toggle} backdrop={backdrop}>
        <ModalHeader toggle={toggle}>Robert Smith </ModalHeader>
        <ModalBody>
         
         <p><b>About Robert</b></p>
         <p>  I've tested various project based on the MERN stack with special focus on Enzyme testing, mocha testing and JMeter performance analysis</p>
      ...
      <ListGroup>
        <ListGroupItem>
          <Row>
            ...
            <Col className="col-6">
              <ListGroupItemHeading>Robert Smith</ListGroupItemHeading>
              <ListGroupItemText>
                <p>
                  Hi, I'm a Frontend Tester
                </p>
                <p>
                  {" "}
                  <b>Technology : React</b>
                </p>
              </ListGroupItemText>
            </Col>
            <Col className="col-4">
